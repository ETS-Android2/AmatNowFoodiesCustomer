...
public class Config {
   ...
   public static String BASE_ADMIN = "https://panel.amatnow.com/mobileapp_api/superAdmin/";

    public static final String Privacy_policy="https://amatnow.com/policy.html";
   ...
   public static String imgBaseURL = "http://domain.com/foodies/mobileapp_api/";
    ...
    public static final String getImageSliders=BASE_ADMIN+"showAppSliderImages";
    public static final String getImageNotification=baseURL+"fetchInAppNotification";
