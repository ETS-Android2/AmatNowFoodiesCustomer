...
public class SingUpActivity extends RootFragment implements AdapterView.OnItemSelectedListener {
    ...
    LinearLayout verificationDiv, mainSignUp, confirmDiv, verificationMainScreen, confirmationMainScreen, signUpScreenDiv;
    TextView btn_signup;
    Button btn_done;


    EditText editText1, editText2, editText3, editText4, eFirst, eLast, eEmail, ePassword, phone;
...
//        phone = (EditText) v.findViewById(R.id.country_phone);
        verificationDiv = v.findViewById(R.id.verification_screen);
        signUpScreenDiv = v.findViewById(R.id.sign_up_screen);
...
//                } else if (phone.getText(true).toString().trim().equals("")) {
        ...
        backIconVerification.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                signUpScreenDiv.setVisibility(View.VISIBLE);
            }
        });
        ...
        btn_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (eFirst.getText().toString().trim().equals("")) {
                    ...
                    signUpScreenDiv.setVisibility(View.GONE);
            ...
            public void onResponce(String resp) {
                try {
                    ...
                    if (code_id == 200) {
                        ...
                        try {
                            int pos = adapter.getPosition("Turkey");
