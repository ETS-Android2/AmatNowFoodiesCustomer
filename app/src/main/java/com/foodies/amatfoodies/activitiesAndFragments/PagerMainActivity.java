...
public class PagerMainActivity extends RootFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        if (bundle != null) {
            ...
            if (bundle.getString("hasAccount") != null)
                hasAccount = bundle.getString("hasAccount");
            if (bundle.getString("hasRestaurant") != null)
                hasRestaurant = bundle.getString("hasRestaurant");
        ...
        if (tabLayout != null) {
            ...
            adapter.setHasRestaurant(hasRestaurant);
    ...
    public void onResume() {
        ...
        if (CartFragmentOld.ORDER_PLACED) {
            selectPage(1);
            CartFragmentOld.ORDER_PLACED = false;
        }
    ...
    private class MyBroadcastReceiver extends BroadcastReceiver {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            View tabView = tab.getCustomView();
            TextView badgeText = (TextView) tabView.findViewById(R.id.tab_badge);
            if (CartFragmentOld.FLAG_CLEAR_ORDER) {
                badgeText.setVisibility(View.GONE);
                CartFragmentOld.FLAG_CLEAR_ORDER = false;
            } else {
                badgeText.setVisibility(View.VISIBLE);
                badgeText.setText("" + count);
            }
