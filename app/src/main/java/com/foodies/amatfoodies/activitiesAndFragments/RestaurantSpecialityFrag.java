            ...
            public void onResponce(String resp) {
                ...
                try {
                    ...
                    if (code_id == 200) {
                        ...
                        SpecialityModel anythingModel = new SpecialityModel();
                        anythingModel.setName("Anything");
                        anythingModel.setId("0");
                        SpecialityModel deliveryModel = new SpecialityModel();
                        deliveryModel.setName("Delivery");
                        deliveryModel.setId("0");

                        specialityArray.add(anythingModel);
                        specialityArray.add(deliveryModel);
                        Collections.shuffle(specialityArray);
                        ...
                        recyclerViewadapter.setOnItemClickListner(new CountryListAdapter.OnItemClickListner() {
                            ...
                            public void OnItemClicked(View view, int position) {
                                String name = specialityArray.get(position).getName();
                                if(name.equals("Delivery")){
                                    Intent nextScreen = new Intent(getApplicationContext(), DeliveryActivity.class);
                                    startActivity(nextScreen);
                                }else {
                                    if (fragmentCallback != null) {
                                        Bundle bundle = new Bundle();
                                        bundle.putString("speciality", name);
